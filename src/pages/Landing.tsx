          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 text-center mb-10" style={{ border: '6px solid black', boxShadow: '6px 6px 0px 0px rgba(0,0,0,1)' }}>
              ...
              <div className="text-base sm:text-lg font-semibold leading-relaxed mb-8 max-w-3xl mx-auto" style={{ color: 'black' }}>
                <p>AOMIGO is a fun AI-powered ecosystem for personal development & community growth💛</p>
              </div>
              <h3 className="text-2xl sm:text-3xl font-black mb-6" style={{ color: 'black' }}>
            ...
            <div className="max-w-full">
              <div className="bg-white rounded-2xl p-6 sm:p-10" style={{ border: '6px solid black', boxShadow: '8px 8px 0px 0px rgba(0,0,0,1)' }}>
                  ...
                  <button
                    onClick={() => {
                      if (jennyAudioPlaying) {
                        ...
                        const text = "Hi everybody, this is Jenny Ruan. When I was a child, I planned to make tons of money and donate them to people. Now I am finally an adult, I found it more effective to connect people and help everybody get the support they need from a community. I talked and met with a lot of people - kid needing accompany, adult needing mentorship, elderly needing IT support - they can all be connected on AOMIGO. We are AOMIGO, fun and helpful.";
                ...
                <div className="space-y-5 mb-6">
                  ...
                  <p className="text-base sm:text-xl font-semibold leading-loose" style={{ color: 'black' }}>
                    Now I am finally an adult, I found it more effective to connect people and help everybody get the support they need from a community.
                  </p>
                  <p className="text-base sm:text-xl font-semibold leading-loose" style={{ color: 'black' }}>
